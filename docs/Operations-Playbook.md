...
Before optimizing anything, it is worth being honest about the cost distribution. On a ninety-tenant estate the assessment itself is not the bottleneck.
