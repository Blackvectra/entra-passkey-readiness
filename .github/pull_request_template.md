...
- [ ] Documentation updated if behavior, parameters, or risk bands changed — including `docs/Risk-Classification.md` if the classification logic moved.
- [ ] `CHANGELOG.md` updated under `[Unreleased]`.
- [ ] Any new date, deadline, or Microsoft behavior claim is cited to Microsoft Learn, not to another tool's output.
